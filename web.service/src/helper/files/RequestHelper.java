...
public class RequestHelper {
    ...
    public RequestHelper setMethod (HttpMethod          method )   {
        this.method    = method;
        return this;
    }
    ...
    private static HttpEntity handleResponse(HttpResponse response) throws AppException {
        ...
        try {
            ...
            throw new AppException(ErrCode.INTERNAL_SERVER_ERROR,e.getCause());        }

        try {
            List<ErrCode> errorCodes = JsonConverter.toList(errResponse, ErrCode.class);
    ...
    public <T> T requestObject(String uri, Class<? extends T> type) throws Exception {
        this.uri = uri;
        return requestObject(type);
    }
    public <T> List<T> requestObject(String uri, Class<T> type, boolean flag) throws Exception {
        this.uri = uri;
        return requestObject(type, flag);
    }
