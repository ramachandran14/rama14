...
import com.ofs.training.java.utility.JsonConverter;
            ...
            while (parameterNames.hasMoreElements()) {
                ...
                if (s.equals("id")) {
                    ...
                    StringBuilder data = new StringBuilder();
                                  data.append("<tr>")
                                      .append("<td>" + pojoPerson.getId() + "</td>")
                                      .append("<td>" + pojoPerson.getFirst_name() + "</td>")
                                      .append("<td>" + pojoPerson.getLast_name() + "</td>")
                                      .append("<td>" + pojoPerson.getBirth_date() + "</td>")
                                      .append("<td>" + pojoPerson.getEmail() + "</td>")
                                      .append("<td>" + pojoPerson.getCreated_date() + "</td></tr>");
                   out.write(data.toString());
                    ...
                    StringBuilder data = new StringBuilder();
                    for(PojoServicePerson pojoPerson1 : personservicepojo) {
                        data.append("<tr>")
                            .append("<td>" + pojoPerson1.getId() + "</td>")
                            .append("<td>" + pojoPerson1.getFirst_name() + "</td>")
                            .append("<td>" + pojoPerson1.getLast_name() + "</td>")
                            .append("<td>" + pojoPerson1.getBirth_date() + "</td>")
                            .append("<td>" + pojoPerson1.getEmail() + "</td>")
                            .append("<td>" + pojoPerson1.getCreated_date() + "</td></tr>");
                   out.write(data.toString());
                   }
                }
            }
