package java.com.ofs.training.java.servlets;

import java.com.ofs.training.java.pojo.PojoServiceAddress;
import java.com.ofs.training.java.service.ServiceAddress;
import java.com.ofs.training.java.utility.ConnectionManager;
import java.com.ofs.training.java.utility.JsonConverter;
        ...
        try {
            ...
            while (parameterNames.hasMoreElements()) {
                ...
                if (s.equals("id")) {
                    ...
                    out.println(service.readAll(connection, pojoAddress));
                }
            }
            connection.close();
