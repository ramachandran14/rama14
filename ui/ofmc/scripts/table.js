...
var show = function(obj) {
    ...
    var element1 = document.getElementById('edit-address');
    element1.appendChild(label1);
    var input1 = document.createElement('input');
    var box1 = document.getElementById('edit-address');
    ...
    var element2 = document.getElementById('edit-address');
    element2.appendChild(label2);
    var input2 = document.createElement('input');
    var box2 = document.getElementById('edit-address');
    ...
    var element3 = document.getElementById('edit-address');
    element3.appendChild(label3);
    var input3 = document.createElement('input');
    var box3 = document.getElementById('edit-address');
    ...
    var element4 = document.getElementById('edit-address');
    element4.appendChild(label4);
    var input4 = document.createElement('input');
    var box4 = document.getElementById('edit-address');
...
var showPerson = function(obj) {
    ...
    var node1 = document.createTextNode('Id :');
    label1.appendChild(node1);
    var element1 = document.getElementById('edit-person');
    element1.appendChild(label1);
    var input1 = document.createElement('input');
    var box1 = document.getElementById('edit-person');
    box1.appendChild(input1);
    ...
    label2.appendChild(node2);
    var element2 = document.getElementById('edit-person');
    element2.appendChild(label2);
    var input2 = document.createElement('input');
    var box2 = document.getElementById('edit-person');
    box2.appendChild(input2);
    ...
    label3.appendChild(node3);
    var element3 = document.getElementById('edit-person');
    element3.appendChild(label3);
    var input3 = document.createElement('input');
    var box3 = document.getElementById('edit-person');
    box3.appendChild(input3);
    ...
    label4.appendChild(node4);
    var element4 = document.getElementById('edit-person');
    element4.appendChild(label4);
    var input4 = document.createElement('input');
    var box4 = document.getElementById('edit-person');
    box4.appendChild(input4);
    ...
    var element5 = document.getElementById('edit-person');
    element5.appendChild(label5);
    var input5 = document.createElement('input');
    var box5 = document.getElementById('edit-person');
    ...
    var element6 = document.getElementById('edit-person');
    element6.appendChild(label6);
    var input6 = document.createElement('input');
    var box6 = document.getElementById('edit-person');
